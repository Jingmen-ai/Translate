...
//                }
    ...
    public synchronized void playVoice(String speakUrl) {
        ...
        if (!TextUtils.isEmpty(speakUrl) && speakUrl.startsWith("http")) {
            ...
            if(ContextCompat.checkSelfPermission(TranslateDetailActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED&&ContextCompat.checkSelfPermission(TranslateDetailActivity.this, Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED&&ContextCompat.checkSelfPermission(TranslateDetailActivity.this, Manifest.permission.ACCESS_NETWORK_STATE) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(TranslateDetailActivity.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                ActivityCompat.requestPermissions(TranslateDetailActivity.this,new String[]{Manifest.permission.INTERNET},1);
                ActivityCompat.requestPermissions(TranslateDetailActivity.this,new String[]{Manifest.permission.ACCESS_NETWORK_STATE},1);
            }
            else {
